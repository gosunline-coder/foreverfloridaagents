...
export default function ToolsPage() {
  ...
  const tools = [
    ...
    { id: "thanks", name: "Thanks.io", desc: "Automated Direct Mail", color: "bg-[#6208CC]/20 border-[#6208CC]/40", iconCol: "text-[#a365ff]", link: "https://thanks.io/", hasCheatSheet: true },
  ];

  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-5xl">
      <div>
        <h1 className="text-3xl font-bold tracking-tight text-foreground">Tool Help Hub</h1>
        <p className="text-muted-foreground mt-2">SOPs, FAQs, and cheat sheets for the systems we use every day.</p>
      </div>
          ...
          <Card key={tool.id} className={`border ${tool.color} shadow-sm`}>
            <CardHeader className="pb-3">
              <div className="flex items-center gap-3">
                <div className={`p-2 rounded-lg bg-background dark:bg-white/5 shadow-sm ${tool.iconCol}`}>
