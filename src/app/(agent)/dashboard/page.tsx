...
import { ArrowRight, PlayCircle, FileText, Package, CheckCircle2, Wrench, XCircle, User } from "lucide-react";
...
export default function DashboardPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-12 animate-in fade-in slide-in-from-bottom-8 duration-700 pb-12 pt-4">
      ...
      <div className="relative overflow-hidden rounded-[2.5rem] bg-card border border-border p-8 md:p-12 backdrop-blur-2xl shadow-2xl">
        ...
        <div className="relative z-10 flex flex-col lg:flex-row gap-10 lg:items-center justify-between">
          <div className="flex-1 w-full">
            <h2 className="text-3xl font-bold text-foreground mb-3 tracking-tight">Onboarding Progress</h2>
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-end px-1">
                <span className="text-5xl font-extrabold text-foreground tracking-tighter">{progressPercent}%</span>
                {isFullyOnboarded && (
              ...
              <Progress value={progressPercent} className="h-6 rounded-full bg-muted [&>div]:bg-brand-blue shadow-inner" />
            </div>
          </div>
          ...
          {!isFullyOnboarded && (
            <div className="shrink-0 flex items-center justify-center lg:pl-10">
              <Link href="/training">
                <Button size="lg" className="h-16 px-10 rounded-full bg-brand-blue hover:bg-brand-blue/90 text-primary-foreground font-bold text-lg shadow-[0_0_40px_-10px_rgba(59,130,246,0.6)] transition-all hover:scale-105 hover:shadow-[0_0_50px_-5px_rgba(59,130,246,0.8)]">
      ...
      {/* Vibrant Quick Links */}
      <div>
        <h3 className="text-2xl font-bold tracking-tight text-foreground mb-6 pl-2">Quick Actions</h3>
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
          <Link href="/profile" className="group">
            <div className="h-full bg-card border border-border rounded-[2rem] p-8 transition-all duration-500 hover:-translate-y-2 hover:border-pink-500/40 hover:shadow-[0_20px_50px_-12px_rgba(236,72,153,0.2)]">
              <div className="w-16 h-16 rounded-2xl bg-pink-500/20 flex items-center justify-center mb-6 group-hover:bg-pink-500 group-hover:scale-110 transition-all duration-500">
                <User className="w-8 h-8 text-pink-500 group-hover:text-white transition-colors" />
              </div>
              <h4 className="text-2xl font-bold text-foreground mb-2">Profile</h4>
              <p className="text-muted-foreground">Manage your credentials</p>
            </div>
          </Link>
          <Link href="/training" className="group">
            <div className="h-full bg-card border border-border rounded-[2rem] p-8 transition-all duration-500 hover:-translate-y-2 hover:border-brand-blue/40 hover:shadow-[0_20px_50px_-12px_rgba(59,130,246,0.2)]">
              ...
              <h4 className="text-2xl font-bold text-foreground mb-2">Training</h4>
              <p className="text-muted-foreground">Continue onboarding</p>
            </div>
          </Link>
          
          <Link href="/documents" className="group">
            <div className="h-full bg-card border border-border rounded-[2rem] p-8 transition-all duration-500 hover:-translate-y-2 hover:border-brand-green/40 hover:shadow-[0_20px_50px_-12px_rgba(34,197,94,0.2)]">
              ...
              <h4 className="text-2xl font-bold text-foreground mb-2">Documents</h4>
              <p className="text-muted-foreground">View required forms</p>
            </div>
          </Link>

          <Link href="/supply" className="group">
            <div className="h-full bg-card border border-border rounded-[2rem] p-8 transition-all duration-500 hover:-translate-y-2 hover:border-orange-500/40 hover:shadow-[0_20px_50px_-12px_rgba(249,115,22,0.2)]">
              <div className="w-16 h-16 rounded-2xl bg-orange-500/20 flex items-center justify-center mb-6 group-hover:bg-orange-500 group-hover:scale-110 transition-all duration-500">
                <Package className="w-8 h-8 text-orange-500 group-hover:text-white transition-colors" />
              </div>
              <h4 className="text-2xl font-bold text-foreground mb-2">Supplies</h4>
              <p className="text-muted-foreground">Order yard signs</p>
            </div>
          </Link>
          
          <Link href="/tools" className="group sm:col-span-2 lg:col-span-1">
            <div className="h-full bg-card border border-border rounded-[2rem] p-8 transition-all duration-500 hover:-translate-y-2 hover:border-[#a365ff]/40 hover:shadow-[0_20px_50px_-12px_rgba(163,101,255,0.2)]">
              ...
              <h4 className="text-2xl font-bold text-foreground mb-2">Tools Hub</h4>
              <p className="text-muted-foreground">Access tech stack</p>
            </div>
          </Link>
        </div>
      </div>
